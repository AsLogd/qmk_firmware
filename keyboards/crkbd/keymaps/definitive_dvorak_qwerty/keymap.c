...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(KC_TAB, KC_QUOT, KC_COMM, KC_DOT, KC_P, KC_Y, KC_F, KC_G, KC_C, KC_R, KC_L, KC_BSPC, KC_LSFT, KC_A, KC_O, KC_E, KC_U, KC_I, KC_D, KC_H, KC_T, KC_N, KC_S, KC_RSFT, KC_LCTL, KC_SLSH, KC_Q, KC_J, KC_K, KC_X, KC_B, KC_M, KC_W, KC_V, KC_Z, TG(5), KC_LALT, MO(3), KC_ENT, KC_SPC, MO(2), KC_LGUI),
	...
	[2] = LAYOUT(KC_ESC, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_F11, KC_F12, KC_PSCR, KC_NO, KC_NO, KC_BSPC, KC_LSFT, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_NO, KC_LCTL, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MO(4), KC_TRNS),
	[3] = LAYOUT(KC_GRV, KC_COMM, KC_DOT, RALT(KC_3), RSFT(KC_NUBS), KC_NO, LSFT(KC_SLSH), KC_PMNS, RALT(KC_LBRC), RALT(KC_RBRC), KC_NO, KC_BSPC, KC_LSFT, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_RSFT, KC_LCTL, LSFT(KC_MINS), RALT(KC_2), KC_NUBS, RALT(KC_4), KC_NO, RALT(KC_1), KC_RBRC, RALT(KC_QUOT), RALT(KC_NUHS), RSFT(KC_LBRC), KC_NO, KC_TRNS, MO(4), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
