...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[3] = LAYOUT(KC_LBRC, LSFT(KC_MINS), KC_COMM, KC_DOT, KC_NUBS, RSFT(KC_NUBS), LSFT(KC_SLSH), KC_PMNS, RALT(KC_LBRC), RALT(KC_RBRC), KC_QUOT, KC_BSPC, KC_LSFT, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_RSFT, KC_LCTL, KC_NO, RALT(KC_2), RALT(KC_3), RALT(KC_4), KC_NO, RALT(KC_1), KC_RBRC, RALT(KC_QUOT), RALT(KC_NUHS), RSFT(KC_LBRC), KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MO(4), KC_TRNS),
